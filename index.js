...
client.connect(err => {
    ...
    app.post('/init', async (req, res) => {
        ...
        const productInfo = {
            ...
            currency: 'BDT',
            tran_id: uuidv4(),
            success_url: 'https://unitymart-server.up.railway.app/success',
            fail_url: 'https://unitymart-server.up.railway.app/failure',
            cancel_url: 'https://unitymart-server.up.railway.app/cancel',
            ipn_url: 'https://unitymart-server.up.railway.app/ipn',
    ...
    app.post("/failure", async (req, res) => {
        ...
        res.redirect(`https://unitymart-c522a.web.app`)
    })
    ...
    app.post('/validate', async (req, res) => {
        ...
        if (result.val_id === req.body.val_id) {
            ...
            res.send("Eaa Boro Chor detected")
        }

    })
    // ORDER ACCORDING TO TRAIN_ID
