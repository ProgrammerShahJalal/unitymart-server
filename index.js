...
client.connect(err => {
    ...
    app.post('/init', async (req, res) => {
        ...
        const productInfo = {
            ...
            currency: 'BDT',
            tran_id: uuidv4(),
            success_url: 'https://unitymart-server.onrender.com/success',
            fail_url: 'https://unitymart-server.onrender.com/failure',
            cancel_url: 'https://unitymart-server.onrender.com/cancel',
            ipn_url: 'https://unitymart-server.onrender.com/ipn',
